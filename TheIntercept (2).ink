...
= _framing_hooper__claim
* [Framing Hooper...] -> claim_hooper_took_component

= _in_with_hooper__insid
...
= _they_are_keeping_me_waiting
- They are keeping me waiting.

= _hut_14_the_door_was_locke
...
* (took) [Take one]
			~ teacup = true
			I take a mug and warm my hands. It's <> -> END
* (what2) {not tellme} "What's going on?"
			"You know already."
			-> pushes_cup
* [Wait]
			I wait for him to speak. -> END
...
* {not teacup} [Don't take it]
 				...
 				~ raise(forceful) -> END
* {teacup} 	[Drink]
				I raise the cup to my mouth but it's too hot to drink. -> END
* {teacup} 	[Wait]
...
-
* [Watch him]
			His face is telling me nothing. I've seen Harris broad and full of laughter. Today he is tight, as much part of the military machine as the device in Hut 5. -> END
* [Wait]
 			I wait to see how he'll respond. -> END
* {not disagree} [Smile]
...
-
* [Yes]
 			"Of course I do," I answer. -> END
* (no) [No]
 			"No I don't. And I've got work to do..."
			"Work that will be rather difficult for you to do, don't you think?" Harris interrupts. -> END
* [Evade]
...
= _forceful__0_what_do_you
* {forceful < 0}	"What do you mean by that?"

= _sore__forceful__0__da
...
= _cooperate_i_know_where_i
* [Co-operate] "I know where it is."
 			-> admitted_to_something

= _nothing_delay_i_know_no
...
* [Explain]
		 	I pause a moment, trying to choose my words. To just come out and say it, after a lifetime of hiding... that is a circle I cannot square. -> END
...
* {evasive > 0} [Evade] "Only that you're being unreasonable, and behaving like a swine."
		...
		"You imbecile," Harris replies, with sudden force. He is half out of his chair. "You know the situation as well as I do. Why the fencing? The Hun are poised like rats, ready to run all over this country. They'll destroy everything. You understand that, don't you? You're not so locked up inside your crossword puzzles that you don't see that, are you? This machine we have here — you men — you are the best and only hope this country has. God help her."
			~ losttemper  = true
			I sit back, startled by the force of his outburst. His carefully sculpted expression has curled to angry disgust. <i>He really does hate me</i>, I think. <i>He'll have my blood for the taste of it.</i> -> END
* * [Placate]
			"Now steady on," I reply, gesturing for him to be calm. -> END
* * [Mock]
			"I can imagine how being surrounded by clever men is pretty threatening for you, Commander," I reply with a sneer. "They don't train you to think in the Armed Forces."
			 ~ raise(forceful) -> END
* * [Dismiss]
			"Then I'll be going, on and getting on with my job of saving her, shall I?" I even rise half to my feet, before he slams the tabletop. -> END
...
* [Confess]
	 	{ forceful > 1 :
		"You want me to tell you what happened? You'll be disgusted." -> END
- else:
...
=== i_met_a_young_man
	//  Explain Story
* [Talk]
		"There was a young man. I met him in the town. A few months ago now. We got to talking. Not about work. And I used my cover story, but he seemed to know it wasn't true. That got me wondering if he might be one of us." -> END
- Harris is not letting me off any more.
		"You seriously entertained that possibility?"
* [Yes]
	 	"Yes, I considered it. <> -> END
* [No]
		...
		I nod. "<> -> END
* [Lie]
		"I was quite certain, after a while. After we'd been talking. <> -> END
...
* [Yes] "It's a lonely life in this place," I reply. "Lonely - and still one never gets a moment to oneself."
		"That's how it is in the Service," Harris answers. -> END
* *	[Argue] "I'm not in the Service."
			Harris shakes his head. "Yes, you are." -> END
* * [Agree] "Perhaps. But I didn't choose this life."
			Harris shakes his head. "No. And there's plenty of others who didn't who are suffering far worse." -> END
...
* (nope) { not drugged  }  [No] "The boy was a pretty simpleton. Quite inferior. His good opinion meant nothing to be. Harris, do not misunderstand. I was simply after his body."
			 ~ raise(evasive)
			Harris, to his credit, doesn't flinch; but I can see he will have nightmares of this moment later tonight. I'm tempted to reach out and take his hand to worsen it for him. -> END
* { drugged  }   		[No]
...
* (yes) [Yes]
		...
		"So what did you do with the component?" Harris talks urgently. He grips his gloves tightly in one hand, perhaps prepared to lift them and strike if it is required. "Have you passed it to this man already? Have you left it somewhere for him to find?" -> END
...
* (notright) [No]
		...
		{ not hooper_mentioned:
			"Hooper!" Harris exclaims, in surprise. {harris_thinks_youre_drugged:He does not doubt me for a moment.} -> END
- else:
...
* * [Evade]
			...
			"I'm sorry to threaten you, friend. But His Majesty needs that brain of yours, and that brain alone. There are plenty of other parts to you that our country could do better without. Now I'll ask you again. Did you hide the component?" -> END
* * * [Yes] -> didnt_have_long
* * * (nope_didnt_hide) [No]
...
* [Answer back]
		...
		"For God's sake," he declares with thick disgust, then swoops away out of the room. -> END
* [Say nothing]
		...
		"God have mercy on your soul," Harris says finally, as he gets to his feet and heads for the door. "I fear no—one else will." -> END
- -> left_alone
...
* [Evade]
	 	"I don't know."
		"You can do better than that. Remember, there's a hangman's noose waiting for traitors." -> END
* * 	[Theorise]
...
* { admitblackmail  }   [Persist with this]
	 		"I know what you're thinking. If I've transgressed once then I must be guilty of everything else... But I'm not. We were close to cracking the 13th's intercept. We were getting correlations in the data. Then Hooper disappeared for a moment, and next minute the machine was down." -> END
* [Tell the truth]
...
* [Assert] "I saw him take it," I continue. "Collins was outside having a cigarette. Peterson was at the table. But I was at the front of the machine. I saw Hooper go around the side. He leant down and pulled something free. I even challenged him. I said, 'What's that? Someone put a nail somewhere they shouldn't have?' He didn't reply."
		 	Harris watches me for a long moment. -> END
* [Imply] "At the moment the machine halted, Peterson was at the bench and Collins was outside having a smoke. I was checking the dip—switches. Hooper was the only one at the back of the Bombe. No—one else could have done it."
				"That's not quite the same as seeing him do it," Harris remarks. -> END
* * 	[Logical]
				 		"When you have eliminated the impossible..." I begin, but Harris cuts me off. -> END
* * 	[Persuasive]
...
* "And the other men?["] Do we have a hut each? Are there  enough senior officers to go round?"
			"Collins was outside when it happened, and Peterson can't get round the machine in that chair of his," Harris replies. "That leaves you and Hooper. -> END
* "Then you know I'm right.["] You knew all along. Why did you threaten me?"
			"All we know is that we have a traitor, holding the fate of the country in his hands. -> END
...
* * 	"Tell Hooper I've confessed.["] Better yet. Let him see you marching me off in handcuffs. Then let him go, and see what he does. Ten to one he'll go straight to wherever he's hidden that component and his game will be up."
					...
					"Interesting," the Commander muses. "But I'm not so sure he'd be that stupid. And if he's already passed the part on, the whole thing will only be a waste of time." -> END
* * * 	"Trust me. He hasn't.["] If I know that man, and I do, he'll be wanting to keep his options open as long as possible. If the component's gone then he's in it up to his neck. He'll take a week at least to make sure he's escaped suspicion. Then he'll pass it on."
							"And if we keep applying pressure to him, you think the component will eventually just turn up?" -> END
* * * * "Yes.["] Probably under my bunk."
									Harris smiles wryly. "We'll know that for a fake, then. We've looked there already. -> END
* * * * "Or be thrown into the river."
									"Hmm." Harris chews his moustache thoughtfully. "Well, that would put us in a spot, seeing as how we'd never know for certain. We'd have to be ready to change our whole approach just in case the part had got through to the Germans. -> END
...
* [Play the part, head down]
	 	From where he's sitting, I know Hooper can see me, so I keep my head down and look guilty as sin. The bastard is probably smiling. -> END
* [Look inside the hut]
		I look in through the door and catch Hooper's expression. I had half expected him to be smiling be he isn't. He looks shocked, almost hurt. "Iain," he murmurs. "You couldn't..." -> END
* (shouted) [Call to Hooper]
	 	I have a single moment to shout something to Hooper before the door closes.
		"I'll get you Hooper, you'll see!" I cry. Then: -> END
* * "Queen to rook two, checkmate!"[] I call, then laugh viciously, as if I am damning him straight to hell.
			 	~ hooperClueType = CHESS -> END
...
* * "Ask not for whom the bell tolls!"
			He stares back at me, as if were a madman and perhaps for a split second I see him shudder. -> END
...
* [Reassure]
		{ not shouted :
			"It will. Hooper's running scared," I reply, hoping I sound more confident than I feel. -> END
- else:
...
* [Dissuade]
		{ not shouted:
			"The Captain thought it was a good scheme. You'll most likely get a promotion." -> END
- else:
...
* [Evade]
		...
		"I've had enough of your voice for one day," Harris replies grimly. <> -> END
* [Say nothing]
		I let him have his rant. <> -> END
...
* [Threaten]
		...
		His eyes bulge with terror. "What did I do, to you? What did I ever do?" -> END
* * 	[Tell the truth]
		 		"You treated me like vermin. Like something abhorrent."
				"You are something abhorrent."
				"I wasn't. Not when I came here. And I won't be, once you're gone." -> END
* * 	[Lie]
		 		"Nothing," I reply. "You're just the other man in the room. One of us has to get the blame." -> END
* * 	[Evade]
		 		"It doesn't matter. Just remember what I said. I've beaten you, Hooper. Remember that." -> END
...
* [Bargain]
		...
		Hooper looks back at me, appalled. "You're asking me to commit treason?" -> END
* * 	[Yes]
		 		"Yes, perhaps. But also to ensure your name goes down in the annals of mathematics. -> back_of_hut_2
* * 	[No]
			 	"No. It's not treason. It's a trade, plain and simple." -> END
* * 	(lie) [Lie]
...
* [Plead]
		...
		"Help you?" Hooper stares. "Help you? You're a traitor. A snake in the grass. And you're <i>queer</i>." -> END
* * 	[Deny]
		 		"I'm no traitor. You <i>know</i> I'm not. How much work have I done here against the Germans? I've given my all. And you know as well as I do, if the Reich were to invade, I would be a dead man. Please, Hooper. I'm not doing any of this lightly." -> END
* * 	[Accept]
		 		"I am what I am," I reply. "I'm the way I was made. But they'll hang me unless you help, Hooper. Don't let them hang me." -> END
* * 	[Evade]
		 		"That's not important now. What matters is what you do, this evening." -> END
...
= _try_to_smash_the_window
try_to_smash_the_window
	The window is my only way out of here. I just need a way to smash it.
* [Punch it]
	 	I suppose my fist would do a good enough job. But I'd cut myself to ribbons, most likely. <> -> END
* (use_bucket) [Find something]
			 ~ smashingWindowItem = BUCKET
			I cast around the small room. There's a bucket in one corner for emergencies — I suppose I could use that. I pick it up but it's not very easy to heft. <> -> END
* [Use something you've got]
		 	I pat down my pockets but all I'm carrying is the intercept, which is no good at all. -> END
* * [Something you're wearing?]
					...
					But I'll cut my hand to ribbons doing it. <> -> END
...
* [Work slowly]
	 		Work carefully? It's difficult to work carefully when all one's has is { smashingWindowItem == BUCKET :a bucket. It's rather like the sledgehammer for the proverbial nut|{ smashingWindowItem == SHOE :a shoe|nothing but brute force}}. -> END
* * 	[Just do it] -> time_to_move_now
* * 	[Look around for something] -> END
* [Find something to help] -> END
...
* (pause) [Wait a little longer]
		 I pause for a moment longer. It doesn't do to be too careless... -> END
* [Clear the frame of shards]
		With my jacket wrapped round my arm, I sweep out the remaining shards of glass. It's not a big window, but I'm not a big man. If I was Harris, I'd be stuffed, but as it is... -> END
...
* [Tell the truth]
			 { i_met_a_young_man  :
				"Please, Harris. You can't understand the pressure they put me under. You can't understand what it's like, to be in love but be able to do nothing about it..." -> END
- else:
...
* [Lie]
			 "I had to get out, Harris. I had to provoke Hooper into doing something that would incriminate himself fully. He's too clever, you see..." -> END
* [Evade]
		 	"This proves nothing," I reply stubbornly. "You still don't have the component and without it, I don't see what you can hope to prove." -> END
...
* [Yes]
			 	My anger deflates like a collapsing equation, all arguments cancelling each other out. The world, of course, owes me nothing; and I owe it everything. -> END
* (alone) [No]
				 <i>Of course not. I am alone; that is what they wanted me to be, because of who and what I love. So I have no nation, no country.</i> -> END
* [Lie] 	-> alone
* [Evade]
				...
				<i>I may as well, therefore, look after myself. Something I have attempted, but failed miserably, to do.</i> -> END
- //  Tell us where
...
- (opts)
* [The bunk]
		The bunk has a solid metal frame, a blanket, a pillow, nothing more. -> END
- - (bunk_opts)
* *  [The frame]
...
-
* [Go the shortest way]
			 	There's no time to lose. Throwing caution to the wind I make my way quickly to Hut 2, and around the back. I don't think I've been seen but if I have it is too late. My actions are suspicious enough for the noose. I have no choice but to follow through. -> END
* [Take a longer route]
				...
				~ muddyshoes  = true
				Still, I can be confident no—one is behind me. I crouch down behind the rear wall of Hut 2. <> -> END
...
* [Take it]
			...
			~ gotcomponent  = true -> END
* [Leave it]
	 		Still there means no—one has found it, which means it is probably well—hidden. And short of skipping the compound now, I can afford to leave it hidden there a while longer. So I leave it in place. -> END
- Where now?
...
* * [Go] 			-> live_on_the_run
* * [Don't go]
				 	It's no good. That's only half a solution. I couldn't be happy with that. -> END
* * * 	[Back to the barracks] 			-> return_to_room_after_excursion
...
* (outer_zip) [Open the outer zip]
			...
			The work is careful, and more than little fiddly — Hooper has tied the zips down on the inside, the fastidious little bastard! — but after a little work I manage to make a hole large enough for my hand. -> END
...
* * [No, some other way]
					...
					No, I must try something else — or nothing at all. -> END
...
* * * 	[Give up]
							There is nothing to be gained here. I have the component now; maybe it will be of some value tomorrow. -> END
...
* (wide_circuit) [Look for another opening]
		 	Making a wide circuit I creep around the tent. It has plenty of other flaps and openings, tied down with Gordian complexity. But nothing afford itself to slipping the component inside. -> END
...
* * [Give up]
				...
				If I can't find a way for Hooper to pick the component up, as if from a hiding place of his own devising, and be caught doing it, then I have no plan at all. -> END
* * * [Return to my barrack] -> return_to_room_after_excursion
* * * [Escape the compound] -> live_on_the_run
* * * [Toss the component into the bushes] -> toss_component_into_bushes
* [Hide the component somewhere]
	 		If I leave the component here somewhere it should be somewhere I can rely on Hooper finding it, but no—one before Hooper. In particular. -> END
* * [Behind the tent]			 	-> wide_circuit
* * [Inside the porch section] 		-> outer_zip
* * [On top of the canvas] 			-> put_component_on_tent

= _put_component_on_tent
...
* (deny) [Deny]
		...
		Harris looks at me with puzzlement. "Someone came by to break the window, and then ran off? That's absurd. That's utterly absurd. Admit it, Manning. You tried to escape and you couldn't get through." -> END
* * [Admit it]
...
* [Agree]
		...
		"Let me tell you what happened this morning. <> -> END
* [Disagree]
	 	"Right now, I think you take that role, Harris," I reply coolly. -> END
...
- Our men watching Hooper's tent saw Hooper wake up, get dressed, clamber out of his tent and then step on something in at the entrance of his tent."
	 	~ piecereturned  = true
* [Be interested]
	 	"You mean he didn't even hide it? He put it in his shoe?" -> END
...
* [Say nothing]
		...
		"In case I'm not making myself clear," Harris continues, "<> -> END
...
* [Suggest something]
		...
		Harris shakes his head, distractedly. "That doesn't make sense," he says. "Why go to all the trouble of stealing it only to give it back? And why like this?" -> END
* * [Suggest something]
...
* (devil) [Approve]
			"I can't tell you enough, I'm glad to hear it. I've had a devil of a night."
			 His gaze flicks to the broken window, but only for a moment. I think he genuinely cannot believe I could have done it. -> END
* [Disapprove]
	 		"You should never have hired him. A below-average intelligence can't be expected to cope with the pressure of our work." -> END
...
* [Thank him]
			...
			I nod, and hurry out of the door. The air outside has never tasted fresher and more invigorating. <> -> END
* [Argue with him]
 				"I'll work as hard as I work."
				"Get out," Harris growls. "Before I decide to arrest you as an accessory."
				I do as he says. Outside the barrack, the air has never smelt sweeter. -> END
...
= __try_it_i_try_the_handle
* * 	[Try it] I try the handle. No such luck.

= __leave_it_i_dont_touch
...
* (optimism) [Be optimistic]
	 	"I'm looking forward to a long bath," I reply. "And getting back to work." -> END
* (pessimism) [Be pessimistic]
	 	"So would you after the night I've had." -> END
- -> harris_certain_is_you
...
* [Evade]
		...
		"Oh, of course. Worked all night, did you? Well, you'll hear soon enough. Can hardly hide the fact there'll only be three of us from now on." -> END
...
* [Co-operate]
	...
	But for now, there's yesterday's intercept to be resolved. -> END
* [Dissemble]
	...
	But not today. Today, there's an intercept to resolve. -> END
* [Lie]
 	In a week's time, this whole affair will be in the past and quite forgotten. I'm quite sure of that. -> moreimportant
* (moreimportant) [Evade] I've more important problems to think about now. There's still yesterday's intercept to be resolved. -> END
...
* [Wave back]
	 		I wave cheerily back and she giggles, almost drops her bicycle, then dashes away inside the House. Judging by the clock on the front gable, she's running a little late this morning. -> END
* [Ignore her]
 			I give no reaction. She sighs to herself, as if this kind of behaviour is normal, and trots away inside the House to begin her duties. -> END
...
* [Check inside]
 			I hop up the steps and put my head inside all the same. Nobody about. Still too early in the AM for sparks, I suppose. <> -> END
...
* (check) [Check]
			...
			Suddenly, there's a movement behind me. I look up to see, first a snub pistol, and then, Harris. -> END
* [Look around]
 			I pause to glance around, and catch a glimpse of movement. Someone ducking around the corner of the hut. Or a canvas sheet flapping in the light breeze. Impossible to be sure. -> END
...
* * 	[Check around the side of the hut]
						...
						Harris is there, leaning in against the wall. He holds a stub pistol in his hand. -> END
- { hooperClueType > STRAIGHT  :
...
* [Agree]
			...
			-> done
* [Lie]
		 	"I spoke to Russell. He said he saw Hooper doing something round here. I wanted to see what it was." -> END
* [Evade]
			...
			I almost wish I had a way to make the hut explode, but of course I don't. -> END
...
* [Protest]
	 	"You can't do this!" I cry. "It's murder! I demand a trial, a lawyer; for God's sake, man, you can't just throw me overboard, we're not barbarians...!" -> END
...
* { gotcomponent  }   			[Show him the component]
			...
			"That's it."
			"But you didn't have it on you yesterday." -> END
* * [Explain]
			 	"I climbed out of the window overnight," I explain. "I went and got this from where it was hidden, and brought it back here." -> END
* * [Don't explain]
				"No. I didn't." -> END
- -> all_too_farfetched
...
* The door is opening.[] Harris is returning. Our little calculation here is complete. { not piecereturned: I can only hope one of the others will be able to explain to him that the part I stole will mean nothing to the Germans.|We are just pieces in this machine; interchangeable and prone to wear.} -> END
...
* [Yes]
		 		But of course I will. { forceful > 2:Perhaps I can persuade them to put him in my cell.|A little vengeance, disguised as doing something good.} -> END
* [No]
		 		No. What would be the use? He will be long gone, and the name he told me is no doubt hokum. No: I was alone before in guilt, and I am thus alone again. -> END
* [Lie]
...
* [Evade]
				...
				{ hooper_mentioned: Hooper, perhaps. He wouldn't like that. } -> END
