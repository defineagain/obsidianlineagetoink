<script lang="ts">
    ...
    import Bridges from 'src/view/components/container/column/components/group/components/card/components/bridges/bridges.svelte';
    import { droppable } from 'src/view/actions/dnd/droppable';
    import TreeIndex from 'src/view/components/container/column/components/group/components/card/components/card-buttons/tree-index-button.svelte';
...
>
    ...
    <CardButtons
        ...
        {outlineMode}
    />
    <TreeIndex activeStatus={active} nodeId={node} {section} {pinned} />
